...
export default function TeamDashboardPage() {
  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <div className="flex overflow-x-auto pb-3 gap-2 border-b border-[rgba(0,0,0,0.06)] scrollbar-thin">
        {teams.map((t) => {
            ...
            <button
              ...
              className={`px-3.5 py-2 rounded-full border text-xs font-bold uppercase whitespace-nowrap transition-all flex items-center space-x-1.5 cursor-pointer ${
                isSelected
                  ...
                  : 'bg-[rgba(0,0,0,0.02)] border-[rgba(0,0,0,0.06)] text-[#6E6E73] hover:text-[#1D1D1F]'
              }`}
              style={{
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="glass p-6 relative overflow-hidden">
            ...
            <div className="mb-6 flex justify-between items-start">
              <div>
                <span className="text-[10px] uppercase font-bold text-[#6E6E73] tracking-wider">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-white/40 border border-[rgba(0,0,0,0.06)] p-3 shadow-sm rounded-2xl">
                <span className="text-[9px] uppercase tracking-wider text-[#6E6E73] block font-semibold">Purse Remaining</span>
                <span className="text-base font-bold text-[#1D1D1F]">{selectedTeam.purse.toFixed(2)} Cr</span>
                <span className="text-[9px] text-[#6E6E73]/60 block mt-0.5">Limit: 120.0 Cr</span>
              </div>
              <div className="bg-white/40 border border-[rgba(0,0,0,0.06)] p-3 shadow-sm rounded-2xl">
                <span className="text-[9px] uppercase tracking-wider text-[#6E6E73] block font-semibold">Squad Size</span>
                <span className="text-base font-bold text-[#1D1D1F]">{selectedTeam.players.length} / 25</span>
                <span className="text-[9px] text-[#6E6E73]/60 block mt-0.5">Min: 12 | Max: 25</span>
              </div>
              <div className="bg-white/40 border border-[rgba(0,0,0,0.06)] p-3 shadow-sm rounded-2xl">
                <span className="text-[9px] uppercase tracking-wider text-[#6E6E73] block font-semibold">Overseas Stars</span>
                <span className="text-base font-bold text-[#1D1D1F]">{squadReport.overseasCount} / 8</span>
                <span className="text-[9px] text-[#6E6E73]/60 block mt-0.5">Max limit: 8</span>
              </div>
              <div className="bg-white/40 border border-[rgba(0,0,0,0.06)] p-3 shadow-sm rounded-2xl">
                <span className="text-[9px] uppercase tracking-wider text-[#6E6E73] block font-semibold">Average Rating</span>
                <span className="text-base font-bold text-[#1D1D1F]">{avgRating} OVR</span>
                <span className="text-[9px] text-[#6E6E73]/60 block mt-0.5">Squad weight</span>
              </div>
            </div>
              ...
              {Object.entries(squadReport.roleCounts).map(([role, count]) => {
                ...
                return (
                  <div key={role} className="space-y-1">
                    <div className="flex justify-between text-[11px] font-semibold text-[#6E6E73]">
          ...
          <div className="glass p-6 space-y-4">
            <h3 className="section-label border-b border-[rgba(0,0,0,0.06)] pb-2.5">
            ...
            <div className="space-y-2.5">
              ...
              {selectedTeam.players.length === 0 && (
                <div className="text-xs text-[#6E6E73]/65 text-center py-4 italic font-medium">
        ...
        <div className="lg:col-span-8 space-y-4">
          {/* View Toggle */}
          <div className="flex justify-between items-center bg-[rgba(0,0,0,0.02)] border border-[rgba(0,0,0,0.06)] p-1.5 rounded-2xl">
            ...
            <div className="pr-2 text-[10px] text-[#6E6E73]/60 uppercase tracking-widest font-bold hidden md:block">
            ...
            <div className="space-y-4">
              {selectedTeam.players.length === 0 ? (
                <div className="glass p-12 text-center">
                  <h3 className="text-lg font-bold text-[#6E6E73]">Empty Draft Desk</h3>
                  <p className="text-xs text-[#6E6E73]/70 mt-1.5 max-w-sm mx-auto font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="md:col-span-5">
                <div className="glass p-6 h-full flex flex-col justify-between">
                  <div>
                    <h3 className="section-label mb-4 border-b border-[rgba(0,0,0,0.06)] pb-2">
                    ...
                    {(() => {
                      ...
                      if (bench.length === 0) {
                        return (
                          <p className="text-xs text-[#6E6E73]/60 text-center py-12 italic font-medium">
                      ...
                      return (
                        <div className="space-y-2 max-h-[380px] overflow-y-auto pr-1">
                          {bench.map((player) => (
                            <div
                              key={player.id}
                              className="flex justify-between items-center bg-white/40 p-2.5 rounded-xl border border-[rgba(0,0,0,0.06)] hover:bg-white/60 transition"
                            >
                              <div className="min-w-0">
                                <span className="font-bold text-xs text-[#1D1D1F] block truncate">
                                  {player.name}
                                </span>
                                <span className="text-[9px] uppercase tracking-wider text-[#6E6E73]/80 flex items-center space-x-1 font-semibold mt-0.5">
                              ...
                              <div className="text-right">
                                <span className="text-[9px] text-[#6E6E73]/60 block uppercase font-bold">Price</span>
                  ...
                  <div className="mt-4 pt-4 border-t border-[rgba(0,0,0,0.06)] text-[10px] text-[#6E6E73] font-medium leading-normal">
