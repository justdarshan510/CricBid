          ...
          <div className="glass-card rounded-3xl p-6 border border-white/5 shadow-xl flex-grow flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="space-y-3 pt-4 border-t border-white/5">
              ...
              <button
                ...
                disabled={!canUserBid}
                className={`w-full py-4 rounded-2xl text-base font-black uppercase tracking-wider transition-all duration-200 shadow-lg ${canUserBid
              ...
              {logs.length === 0 ? (
                ...
                logs.map((log, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`text-xs p-2.5 rounded-xl border transition animate-fade-in ${isSold
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {teams.map((t) => {
              ...
              return (
                <div
                  key={t.id}
                  className={`glass-card p-3 rounded-xl border flex flex-col justify-between transition-all duration-300 ${isCurrentBidder
